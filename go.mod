...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.66.0 // @grafana/plugins-platform-backend
	go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace v0.66.0 // @grafana/grafana-operator-experience-squad
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.66.0 // @grafana/sharing-squad
	go.opentelemetry.io/contrib/propagators/jaeger v1.41.0 // @grafana/grafana-backend-group
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.35.0 // @grafana/grafana-backend-group
