...
require (
	...
	github.com/grafana/pyroscope/api v1.3.0 // @grafana/observability-traces-and-profiling
	...
	github.com/grpc-ecosystem/grpc-gateway/v2 v2.27.5 // @grafana/identity-access-team
